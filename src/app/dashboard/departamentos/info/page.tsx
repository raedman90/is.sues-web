  ...
  return (
    <DashboardLayout>
      <div className="flex flex-col h-full text-white">
        ...
        {/* Cabeçalho Fixo */}
        <div className="p-4 flex items-center gap-3 border-b border-gray-700 bg-[#2A2D34] shadow-md">
          <motion.button 
        ...
        {/* Conteúdo com Rolagem para Mobile */}
        <div className="flex-1 overflow-y-auto p-6">
          
          {/* Seleção de Departamento */}
          <div className="bg-[#2A2D34] p-4 rounded-lg border border-gray-700 mb-6">
          ...
          {selectedDepartment && department ? (
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <motion.div 
                ...
                className="bg-[#2A2D34] p-4 rounded-lg border border-gray-700 h-full"
              >
                <h2 className="text-lg font-semibold flex items-center gap-2 text-gray-300 mb-4">
                  <FaUser /> Funcionários
                </h2>
                {department.users && department.users.length > 0 ? (
                  <ul className="max-h-[300px] overflow-y-auto custom-scrollbar space-y-2">
              ...
              {/* Coluna 2: Informações do Departamento */}
              <div className="bg-[#2A2D34] p-6 rounded-lg border border-gray-700 h-full lg:col-span-1">
                <h2 className="text-xl font-semibold text-gray-300 mb-4">Detalhes do Departamento</h2>
                <p className="text-gray-400"><strong>Nome:</strong> {department.name}</p>
              </div>
